...
component_arc_map,component_id_map=get_component(G_without_arcs,center_SEpair_map)
...
graph,newcomponent_map,start_id=get_compoment_graph(component_arc_map,component_id_map)
...
processor = UnfoldProcessor( lines,arcs, circles,center_arc_map,newcomponent_map,delete,left_model)
